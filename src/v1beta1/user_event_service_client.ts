...
export class UserEventServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.descriptors.page = {
      listUserEvents: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'userEvents'
      ),
    ...
    const importUserEventsResponse = protoFilesRoot.lookup(
      '.google.cloud.recommendationengine.v1beta1.ImportUserEventsResponse'
    ) as gax.protobuf.Type;
  ...
  writeUserEvent(
    ...
    [
      ...
      (
        | protos.google.cloud.recommendationengine.v1beta1.IWriteUserEventRequest
        | undefined
      ),
      {} | undefined
    ]
  ...
  collectUserEvent(
    ...
    [
      ...
      (
        | protos.google.cloud.recommendationengine.v1beta1.ICollectUserEventRequest
        | undefined
      ),
      {} | undefined
    ]
  ...
  async checkPurgeUserEventsProgress(
    ...
    LROperation<
      protos.google.cloud.recommendationengine.v1beta1.PurgeUserEventsResponse,
      protos.google.cloud.recommendationengine.v1beta1.PurgeUserEventsMetadata
    >
  > {
  ...
  async checkImportUserEventsProgress(
    ...
    LROperation<
      protos.google.cloud.recommendationengine.v1beta1.ImportUserEventsResponse,
      protos.google.cloud.recommendationengine.v1beta1.ImportMetadata
    >
  > {
    const request = new operationsProtos.google.longrunning.GetOperationRequest(
      {name}
  ...
  listUserEventsStream(
    ...
    return this.descriptors.page.listUserEvents.createStream(
      this.innerApiCalls.listUserEvents as gax.GaxCall,
      request,
      callSettings
    );
  }
