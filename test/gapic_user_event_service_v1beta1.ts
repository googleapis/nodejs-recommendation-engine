...
describe('v1beta1.UserEventServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      usereventserviceModule.v1beta1.UserEventServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      usereventserviceModule.v1beta1.UserEventServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });
    ...
    it('invokes writeUserEvent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.writeUserEvent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.recommendationengine.v1beta1.IUserEvent | null
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.purgeUserEvents(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.recommendationengine.v1beta1.IPurgeUserEventsResponse,
              protos.google.cloud.recommendationengine.v1beta1.IPurgeUserEventsMetadata
            > | null
          ) => {
            if (err) {
              reject(err);
      ...
      const promise = new Promise((resolve, reject) => {
        client.importUserEvents(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.recommendationengine.v1beta1.IImportUserEventsResponse,
  ...
  describe('listUserEvents', () => {
    it('invokes listUserEvents without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.listUserEvents as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });
    ...
    it('invokes listUserEvents without error using callback', async () => {
      ...
      client.innerApiCalls.listUserEvents = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listUserEvents with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.listUserEvents = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listUserEventsStream without error', async () => {
      ...
      client.descriptors.page.listUserEvents.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.recommendationengine.v1beta1.UserEvent
          ) => {
      ...
      assert(
        (client.descriptors.page.listUserEvents.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listUserEvents, request)
      );
      assert.strictEqual(
        (client.descriptors.page.listUserEvents
    ...
    it('uses async iteration with listUserEvents without error', async () => {
      ...
      client.descriptors.page.listUserEvents.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
